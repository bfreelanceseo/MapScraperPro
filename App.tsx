  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans text-gray-900">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        {currentView === 'home' ? renderHome() : <Documentation onBack={() => setCurrentView('home')} />}
      </main>
      
       <footer className="bg-white border-t border-gray-200 mt-auto">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm text-gray-400">
                &copy; 2025 MapScraperPro. Powered by <a href="https://www.bestfreelanceseo.com" title="Best Freelance SEO" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">Best Freelance SEO</a> & Google Maps Grounding. Developer : <a href="https://www.linkedin.com/in/habeebrahmanb" title="HABEEB RAHMAN" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors">HABEEB RAHMAN</a>
            </p>
        </div>
      </footer>
    </div>
